 ...
 * <p>
 * File Name:       [ServoHandler.ino]
 * Developer:       Dinh Hieu Minh
 * Description:     [The Arduino code that handle the servo's physic based on recieved serial signal]
 ******************************************************************************/
